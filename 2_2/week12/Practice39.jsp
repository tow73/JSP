...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*" import="jspbook.pr39.*"%>
...
<body>
	<jsp:useBean id="lec" class="jspbook.pr39.LectureBean" />
	<jsp:setProperty name="lec" property="*" />
	<jsp:useBean id="lecm" class="jspbook.pr39.LectureManager" scope="session" />
